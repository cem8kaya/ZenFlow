    ...
    var body: some View {
            ZStack {
                ...
                VStack(spacing: 30) {
                    ...
                    if showText {
                        VStack(spacing: 12) {
                            // DÜZELTME 1: Başlık için defaultValue eklendi
                            Text(String(localized: "session_complete_title", defaultValue: "Meditasyon Tamamlandı!", comment: "Meditation completed title"))
                                .font(.system(size: 28, weight: .bold))
                                .foregroundColor(.white)

                            // DÜZELTME 2: Süre metni (bu zaten çalışıyordu ama garantiye alalım)
                            ...
                            // DÜZELTME 3: Tebrik mesajı için defaultValue eklendi
                            Text(String(localized: "session_complete_congratulations", defaultValue: "Harika bir seans! 🧘‍♀️", comment: "Congratulations message"))
                                .font(.body)
                    ...
                    if showMoodSelector && !moodSelectionComplete {
                        VStack(spacing: 20) {
                            // DÜZELTME 4: Soru metni için defaultValue eklendi
                            Text(String(localized: "session_complete_mood_question", defaultValue: "Nasıl hissediyorsun?", comment: "How are you feeling?"))
                            ...
                            Button(action: {
                                ...
                                // DÜZELTME 5: Atla butonu için defaultValue eklendi
                                Text(String(localized: "session_complete_skip", defaultValue: "Atla", comment: "Skip button"))
